...
VISTA_1906.tune_lam1(VISTA_1906.lam2_opt, metric = 'rmse',
...
import json, pathlib
pathlib.Path(f"lams_{k}.json").write_text(json.dumps({"lam_results": lam_results, "lam_results_quantile": lam_results_quantile}))
