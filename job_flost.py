...
'''
VISTA_1906.validation_tune_lam1(VISTA_1906.lam2_opt)
...
VISTA_1906.validation_tune_lam2(lower=50, upper=2000, lam1=VISTA_1906.sv2, metric = 'rmse',
                  init_points=10, n_iter=50,verbose = 0,random_state=0)
VISTA_1906.validation_tune_lam1_parallel(VISTA_1906.lam2_opt)
lam_results_quantile = VISTA_1906.lam2_opt + VISTA_1906.lam1_opt
#VISTA_1906.validation_tune_lam1(tune_start, 50,
#                                VISTA_1906.lam2_opt, metric = 'rmse',
#                                init_points=5, n_iter=50,verbose = 0,random_state=0,)
#if tune_start == 2:
#    lam_results_quantile = VISTA_1906.lam2_opt + VISTA_1906.lam1_opt
...
pathlib.Path(f"validation_lams_{k}_{tune_start}.json").write_text(json.dumps({"lam_results": lam_results, "lam_results_quantile": lam_results_quantile}))
